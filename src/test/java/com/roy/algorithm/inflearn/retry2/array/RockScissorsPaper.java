...
public class RockScissorsPaper {
    ...
    public char[] solution1(int[] aUser, int[] bUser) {
        char[] answer = new char[aUser.length];
        for (int i = 0; i < aUser.length; i++) {
            if (aUser[i] == bUser[i]) {
                answer[i] = 'D';
            } else if (aUser[i] == 1 && bUser[i] == 3) {
                answer[i] = 'A';
            } else if (aUser[i] == 2 && bUser[i] == 1) {
                answer[i] = 'A';
            } else if (aUser[i] == 3 && bUser[i] == 2) {
                answer[i] = 'A';
            } else {
                answer[i] = 'B';
            }
    ...
    public void main() {
        int[] aUser = {2, 3, 3, 1, 3};
        int[] bUser = {1, 1, 2, 2, 3};
        char[] expectedAnswer = {'A', 'B', 'A', 'B', 'D'};
        char[] answer = solution1(aUser, bUser);
